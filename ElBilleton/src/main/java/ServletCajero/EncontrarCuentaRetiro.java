 ...
 * @author potz
 */
@WebServlet(name = "EncontrarCuentaRetiro", urlPatterns = {"/EncontrarCuentaRetiro"})
public class EncontrarCuentaRetiro extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EncontrarCuentaRetiro</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EncontrarCuentaRetiro at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
       ...
       CuentaModel cuenta = new CuentaModel();
        ...
        try {
            if (cuenta.buscarCuentaCodigo(cuentanum) != null) {
                ...
                request.getRequestDispatcher("/Cajero/IngresarCuentaRetiro.jsp").forward(request, response);
            }
