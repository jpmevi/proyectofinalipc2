<%-- 
    Document   : Reporte5
    Created on : Nov 15, 2020, 6:53:14 AM
    Author     : potz
--%>
...
<html>
    ...
    <body style="background: url('${pageContext.request.contextPath}/img/fondo.png') center ; background-attachment: fixed;">
        ...
        <form  >
            <div class="cajatabla">
                <h2 >Clientes que no han realizado transacciones</h2>
                ...
                <a class="btn solid" href="${pageContext.request.contextPath}/Clientessintransaccion?fecha1=${fecha1}&&fecha2=${fecha2}">Exportar reporte</a>
            </div>
        </form>
