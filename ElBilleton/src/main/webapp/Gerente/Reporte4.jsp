<%-- 
    Document   : Reporte4
    Created on : Nov 15, 2020, 6:02:49 AM
    Author     : potz
--%>
...
<html>
    ...
    <body style="background: url('${pageContext.request.contextPath}/img/fondo.png') center ; background-attachment: fixed;">
        ...
        <form  >
            <div class="cajatabla">
                <h2 >Clientes con mas dinero en sus cuentas ${monto}</h2>
                ...
                <a class="btn solid" href="${pageContext.request.contextPath}/Clientesmasdinero">Exportar reporte</a>
            </div>
        </form>
