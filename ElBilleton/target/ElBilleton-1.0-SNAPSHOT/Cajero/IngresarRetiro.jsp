<%-- 
    Document   : IngresarRetiro
    Created on : Nov 17, 2020, 7:20:16 AM
    Author     : potz
--%>
...
<html>
    ...
    <body style="background: url('${pageContext.request.contextPath}/img/bgformulario.png') left ; background-attachment: fixed;">
        ...
        <form action="RealizarRetiro" method="post" >
            <div class="caja">
                ...
                <div class="inputAnimate">
                    <input type="text"  value="${cuenta.getMonto()}" name="cliente" readonly>
                </div>
                <h4>Monto a retirar:</h4>
                <div class="inputAnimate">
                    <input type="number"  min="0"  step="0.1" name="monto">
                </div>
                <button class="draw" type="submit" name="gen">Retirar</button>
