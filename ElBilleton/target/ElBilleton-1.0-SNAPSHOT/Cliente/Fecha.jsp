<%-- 
    Document   : Fecha
    Created on : Nov 17, 2020, 2:37:16 AM
    Author     : potz
--%>
    ...
    <body style="background: url('${pageContext.request.contextPath}/img/bgformulario.png') left ; background-attachment: fixed;">
        ...
        <form action="${pageContext.request.contextPath}/Comprobarfecha" method="post" >
            <div class="caja">
                ...
                <c:if test="${no == 1}">
                <p id="error" style="color: red;">La fecha de inicio tiene que ser antes que la fecha actual</p>
            </c:if>
            </div>
