<%-- 
    Document   : TransaccionesReporte3
    Created on : Nov 17, 2020, 3:34:26 AM
    Author     : potz
--%>
    ...
    <body style="background: url('${pageContext.request.contextPath}/img/fondo.png') center ; background-attachment: fixed;">
        ...
        <form action="BuscarCuenta" method="post" >
            <div class="cajatabla">
                ...
                <a class="btn solid" href="${pageContext.request.contextPath}/Transaccionescuentamasdinero?cuenta=${Cuenta.getCodigo()}&&fecha1=${fecha1}">Exportar reporte</a>
            </div>
        </form>
